...
- **$ \mathbf{A} $:** 资产集合 $ A = \{A_1, A_2, ..., A_n\} $
- **$ \mathbf{P^{CEX}_i} $:** CEX 上资产 $ A_i $ 的价格
- **$ \mathbf{P^{DEX}_i} $:** DEX 上资产 $ A_i $ 的价格
- **$ \mathbf{\Delta P_i} $:** 价格差异 $ \Delta P_i = P^{DEX}_i - P^{CEX}_i $
- **$ \mathbf{Q^{CEX}_i} $:** CEX 上资产 $ A_i $ 的交易量
- **$ \mathbf{Q^{DEX}_i} $:** DEX 上资产 $ A_i $ 的交易量
- **$ \mathbf{f^{CEX}} $:** CEX 交易费率
- **$ \mathbf{f^{DEX}} $:** DEX 交易费率
- **$ \mathbf{G} $:** DEX 交易的 gas 成本
- **$ \mathbf{E_i} $:** 资产 $ A_i $ 的净敞口
- **$ \mathbf{C^{CEX}} $:** CEX 上分配的资本
- **$ \mathbf{C^{DEX}} $:** DEX 上分配的资本
- **$ \mathbf{\sigma_i} $:** 资产 $ A_i $ 的价格波动率
- **$ \mathbf{\rho} $:** CEX 和 DEX 价格变动的相关系数
