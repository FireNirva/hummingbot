...
- **$ \mathbf{P_C} $:** Asset price on CEX
- **$ \mathbf{P_D} $:** Asset price on DEX
- **$ \mathbf{f_C} $:** CEX trading fee rate
- **$ \mathbf{f_D} $:** DEX trading fee rate
- **$ \mathbf{f_{W,C}} $:** CEX withdrawal fee rate
- **$ \mathbf{f_{D,C}} $:** CEX deposit fee rate
- **$ \mathbf{G} $:** Gas cost on DEX
- **$ \mathbf{Q} $:** Trading quantity
- **$ \mathbf{Q_{max,C}} $:** Maximum trading quantity on CEX
- **$ \mathbf{Q_{max,D}} $:** Maximum trading quantity on DEX (liquidity constraint)
- **$ \mathbf{\tau_{C,D}} $:** Transfer time from CEX to DEX
- **$ \mathbf{\tau_{D,C}} $:** Transfer time from DEX to CEX
- **$ \mathbf{\Delta P} $:** Price difference $ \Delta P = |P_C - P_D| $
- **$ \mathbf{\sigma_C} $:** CEX price volatility
- **$ \mathbf{\sigma_D} $:** DEX price volatility
- **$ \mathbf{\rho} $:** Correlation coefficient between CEX and DEX prices
- **$ \mathbf{C_{transfer}} $:** Transfer cost
- **$ \mathbf{r_{risk}} $:** Risk adjustment factor
- **$ \mathbf{T_{cycle}} $:** Complete arbitrage cycle time
- **$ \mathbf{C_{total}} $:** Total available capital
- **$ \mathbf{r_{opportunity}} $:** Capital opportunity cost rate
