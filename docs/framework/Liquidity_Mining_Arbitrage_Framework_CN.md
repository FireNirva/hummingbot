...
- **$ \mathbf{P_A} $:** 代币A的价格
- **$ \mathbf{P_B} $:** 代币B的价格
- **$ \mathbf{r_{LP}} $:** 流动性挖矿年化收益率
- **$ \mathbf{r_{reward}} $:** 奖励代币的年化收益率
- **$ \mathbf{P_{reward}} $:** 奖励代币的价格
- **$ \mathbf{f_{DEX}} $:** DEX交易费率
- **$ \mathbf{f_{LP}} $:** 流动性提供者获得的交易费比例
- **$ \mathbf{L} $:** 提供的流动性金额
- **$ \mathbf{T_{LP}} $:** 流动性提供的时间周期
- **$ \mathbf{Q_{A}} $:** 提供的代币A数量
- **$ \mathbf{Q_{B}} $:** 提供的代币B数量
- **$ \mathbf{V_{DEX}} $:** DEX上的交易量
- **$ \mathbf{\Delta P} $:** 套利价格差异
- **$ \mathbf{IL} $:** 无常损失
- **$ \mathbf{G} $:** 区块链交易的gas成本
- **$ \mathbf{C_{total}} $:** 策略的总可用资本
- **$ \mathbf{w_{LP}} $:** 分配给流动性提供的资本比例
- **$ \mathbf{w_{trade}} $:** 分配给套利交易的资本比例
